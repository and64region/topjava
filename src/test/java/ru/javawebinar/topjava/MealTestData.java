...
public class MealTestData {
    ...
    public static void assertMatchForTo(Iterable<MealTo> actual, Iterable<MealTo> expected) {
        assertThat(actual).usingElementComparatorIgnoringFields().isEqualTo(expected);
    }

    public static ResultMatcher contentJson(List<MealTo> mealTos) {
        return result -> assertMatchForTo(readListFromJsonMvcResult(result, MealTo.class), mealTos);
    }
