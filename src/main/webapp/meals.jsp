...
<table border=1>
    ...
    <c:forEach items="${mealsListWithExcees}" var="mealTo">
        ...
        <tr>
            ...
            <td style="${col}"><a href="mealsList?action=edit&userId=<c:out value="${mealTo.id}"/>">Обновить</a></td>
            <td style="${col}"><a href="mealsList?action=delete&userId=<c:out value="${mealTo.id}"/>">Удалить</a></td>
