...
@NamedQueries({
        ...
        @NamedQuery(name= Meal.GET_BETWEEN, query = "SELECT m FROM Meal m WHERE m.user=:user  AND m.dateTime>=:startDate AND m.dateTime<=:endDate ORDER BY m.dateTime DESC")
